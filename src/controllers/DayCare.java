...
public class DayCare {
    ...
    public String listAllPets() {
        String str = "";
        // Uses a for each loop to scan through the array list adding the index and pet to String details of each pet to String str
        for(Pet pet: pets) {
    ...
    public String listAllCats() {
        ...
        for(Pet pet: pets) {
            // If a pet at the index checked uses the Cat class adds the index and to String for the cat to String str
    ...
    public String listAllDogs() {
        ...
        // Uses a for each loop to scan through the array list.
        for(Pet pet: pets) {
            // If a pet at the index checked uses the Dog class adds the index and to String for the cat to String str
